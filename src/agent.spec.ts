...
describe("High Gas and Tether Agent", () => {
  ...
  beforeAll(() => {
    handleTransaction = agent.provideHandleTransaction(mockHighGasFeeAgent, mockHighTetherAgent, mockGetTransactionReceipt);
  })
  ...
  describe("handleTransaction", () => {
    it("invokes highTetherAgent and highGasFeeAgent and retruns their findings", async () => {
      ...
      expect(mockHighGasFeeAgent.handleTransaction).toHaveBeenCalledWith(mockTxEvent, ethers.BigNumber.from(mockGasUsed));
